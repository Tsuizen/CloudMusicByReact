...
const PrivateContentItem: React.FC<PrivateContentItemProps> = (props) => {
  return (
    <li className='flex flex-col justify-start cursor-pointer relative'>
      <img className='rounded-md' src={props.content.picUrl} alt="" />
      {/* 标题 */}
      <span className=' mt-2 text-md overflow-ellipsis text-gray-500 h-12 py-1 break-all hover:text-white'>
        {props.content.name}
      </span>
      {/* 按钮 */}
